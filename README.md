...
- **Google Cloud** for Workspace APIs and Gemini AI
- **MCP Protocol** community for extensible tool architecture
- **React Native Community** for voice and speech libraries

---

**Built with ❤️ using Expo, React Native, and cutting-edge AI technologies.**

For detailed architecture documentation, see [ARCHITECTURE.md](SupabaseAuthApp/ARCHITECTURE.md).
For voice feature examples, see [VOICE_FEATURES.md](SupabaseAuthApp/VOICE_FEATURES.md).