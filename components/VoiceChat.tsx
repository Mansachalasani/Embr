...
//         // On web, check if MediaRecorder supports required formats
...
//           } else {
//             console.log('✅ Supported audio format:', supported);
//           }
//         }
//       }
//     } catch (error) {
...
//     if (disabled || !hasPermission) return styles.disabledButton;
//     if (isRecording) return styles.recordingButton;
//     if (isProcessing) return styles.processingButton;
//     if (isPlaying) return styles.playingButton;
...
//     if (isPlaying) return 'Playing response... tap to interrupt';
//     return 'Tap to speak';
//   };
